    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#<%= btnProceed.ClientID %>').click(function () {
                ...
                if ($('input[id$=cbxAccept]').attr("checked") == true) {
                    return true;
                }
                else {
                    alert('Please click on "I Accept above Terms and Conditions." checkbox before proceed');
                    return false;
                }
                    ...
                    <tr>
                        <td style="border: thin solid #834717; text-align: left; vertical-align: top" align="left" 
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="labelBoldRight">Business Name:<span class="labelBoldRed">*</span><br />(Billing Name)</td>
                                    <td align="left" valign="top" style="text-align: left; vertical-align: top">
                 ...
                 <tr>
                  ...
                  <tr>
                    <td class="labelBoldRed">
                        <ol>
                              <li>BY SIGNING THIS ORDER FORM, CUSTOMER AGREES ALL TERMS AND CONDITIONS SET BY SWAMINARAYAN AKSHARPITH, INC FOR CALENDAR PROJECT</li>
                              <li>SWAMINARAYAN AKSHARPITH INC CONSIDERS ORDER INCOMPLETE IF</li>
                                <ul>
                                  <li>ORDER IS NOT SIGNED BY SPONSOR/CUSTOMER AND ORDER RECEIVING KARYAKAR</li>
                                  <li>ADVERTISEMENT MATERIAL IS NOT RECEIVED BY SWAMINARAYAN AKHARPITH INC, AS PER SET DEADLINE</li>
                                  <li>ADVERTISEMENT PROOF IS NOT CONFIRMED BY SET DEADLINE</li>
                                  <li>PAYMENT IS NOT RECEIVED</li>
                                </ul>

                                <%--<li>IF ORDERS RECEIVED REMAINED INCOMPLETE (REFER 'B' IN EMAILED PACKAGE) BY DEAD LINE SET BY SWAMINARAYAN AKSHARPITH, INC. 
                                 SWAMINARAYA AKSHARPITH, INC CAN NOT BE HELD LIABLE IF DELIVERIES ARE DELAYED FOR ANY REASON/S.
                                </li>--%>
                                <li>CANCELLATION POLICY: </li>
                                 <ul>
                                  <li>COMPLETED(ORDER FORM, ADVERTISEMENT & PAYMENT) ORDERS CANNOT BE CANCELLED</li>
                                  <li>IF ORDERS REMAINS INCOMPLETE (REFER "2") BY THE SET DEADLINE, IT WILL BE TREATED AS CANCELLED</li>
                                </ul>
                                 <li>PAYMENT POLICY:</li>
                                 <ul>
                                  <li>PAYMENT WILL BE ACCEPTED THROUGH CHECK, MONEY ORDER AND CREDIT CARD</li>
                                  <li>PAYMENT IS REQUIRED TO COMPLETE ORDER BY SET DEAD LINE</li>
                                </ul>
                                 <li> ORDERS ARE NON REFUNDABLE</li>
                                  <li>SWAMINARAYAN AKSHARPITH, INC WILL NOT BE RESPONSIBLE FOR THE LOSS AND/OR DELAYS AND/OR DAMAGES IN TRANSIT
                                    DUE TO FORSEEN/UNFORSEEN CIRCUMSTANCES SUCH AS NATURAL DISASTER, CUSTOMS EXAMS/HOLDS, CARGO THEFT/LOSS ETC
                                  </li>
                          </ol>
                    </td>
                  </tr>    
                  <tr>
                    <td>
                        <asp:CheckBox ID="cbxAccept" 
                            runat="server" 
                            Text="I Accept above Terms and Conditions"
                            TextAlign="Right" 
                            CssClass="labelBoldCenter" />
                        <br />  
        ...
        <tr>
            <td>
                <asp:Button ID="btnProceed" runat="server" Font-Bold="True" OnClick="btnCheckOut_Click"
                    Text="Confirm and Proceed" CssClass="btn" 
                    ValidationGroup="upBusinessInfo" />

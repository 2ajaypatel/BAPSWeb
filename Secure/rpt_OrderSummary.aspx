<%@ Page Title="Report - Order Summary by Center" Language="C#" MasterPageFile="~/Secure/Calendar.master" AutoEventWireup="true" CodeFile="rpt_OrderSummary.aspx.cs" Inherits="Admin_SearchOrderByCenter" %>
    ...
    <tr>
        <td style="text-align:center; vertical-align:top">
            <table align="center"  style="width:100%">
                <tr>
                    <td width="30%">&nbsp</td>
                    <td width="30%"><h1>Order Summary</h1></td>
                    <td align="right" width="30%" style="vertical-align:middle">
                      <%--  onclick="imgBtnPdf_Click" --%>
                        <asp:ImageButton ID="imgBtnPdf" width="40" height="40" runat="server" ImageUrl="~/Images/pdf1.png" ToolTip="Click here to download order detail..." />

                        <asp:ImageButton ID="imgBtnExcel" runat="server" ImageUrl="~/Images/excel.png" onclick="imgBtnExcel_Click" ToolTip="Click here to download order detail..." />
                    </td>
                </tr>
            </table>
        </td>

<%@ Page Title="Customer Order Count By Region" Language="C#" MasterPageFile="~/Admin/Admin.master"
    AutoEventWireup="true" CodeFile="rpt_OrderSummaryByRegion.aspx.cs" Inherits="Admin_rpt_OrderSummaryByRegion" %>
        ...
        <tr>
            <td>
                <asp:Chart ID="chartRegion" 
                    ...
                    <Series>
                        <asp:Series  Name="Series1" ToolTip="Multi Page Total Order: #VALY" ChartArea="ChartArea1"
                            IsValueShownAsLabel="True" ChartType="Column" LegendText="Multi Page">
                        </asp:Series>
                        
                        <asp:Series Name="Series2" ToolTip="Single Page Total Order: #VALY" ChartArea="ChartArea1"

<%@ Page Title="Order Summary By Center" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="dsp_ViewOrders.aspx.cs" Inherits="Admin_SearchOrderByCenter" %>
                  ...
                  <%--  <asp:TemplateField   >
                    ...
                    <asp:CommandField ShowSelectButton="True" 
                      ...
                      <asp:HyperLinkField 
                               ...
                               Text="<img src='../Images/Upload-icon.png' border='0' title='Click here to upload advertisement.' />" 
                            />
                   ...
                   <asp:BoundField DataField="adminstatus" HeaderText="Admin Status" />
                        <asp:BoundField DataField="designstatus" HeaderText="Design Status" />

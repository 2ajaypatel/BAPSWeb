<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true"
    CodeFile="rpt_SearchOrderByCenter.aspx.cs" Inherits="Admin_SearchOrderByCenter" %>
        ...
        <tr>
            <td style="text-align: left; vertical-align: top" align="left" nowrap="nowrap" valign="top"
                ...
                <asp:DropDownList ID="ddlbCenter" runat="server" Font-Size="Smaller" AppendDataBoundItems="True"
                    AutoPostBack="True" DataSourceID="sdCenterList" DataTextField="CenterName" DataValueField="CenterID"
        ...
        <tr>
            <td style="text-align: center; vertical-align: top" align="center" valign="top">
                <asp:GridView ID="gv" runat="server" BackColor="White" BorderColor="#2E2842" BorderStyle="Solid"
                    BorderWidth="1px" CellPadding="4" AutoGenerateColumns="False" Width="100%" OnRowCommand="gv_RowCommand"
                    OnRowDeleting="gv_RowDeleting" OnRowDeleted="gv_RowDeleted" DataKeyNames="orderID,ClientID"
                    EmptyDataText="No data in the data source." CssClass="mGrid" AllowPaging="True"
                    ...
                    <tr>
                        <td width="50%" height="50%" valign="top">
                            <asp:DetailsView ID="dvClient" runat="server" Width="100%" AutoGenerateRows="False"
                                BackColor="white" BorderColor="Tan" BorderWidth="1px" CellPadding="2" DataKeyNames="ClientID"
                                ...
                                <HeaderStyle ForeColor="#FFFFCC" BackColor="#FF9900" HorizontalAlign="Center" Font-Size="Larger"
                                    Font-Bold="true" />
                                <RowStyle Height="25" />
                                <Fields>
                        ...
                        <td width="50%" height="50%" valign="top">
                            <asp:DetailsView ID="dvMemberDetail" runat="server" AutoGenerateRows="False" DataKeyNames="MemberID"
                                DataSourceID="sdMemberDetail" Width="100%" BackColor="white" BorderColor="Tan"
                                BorderWidth="1px" CellPadding="1" ForeColor="Black" GridLines="None" HeaderText="Karyakar Details"
                                Font-Bold="False">
                                <AlternatingRowStyle BackColor="#E8E8E8" />
                                <CommandRowStyle HorizontalAlign="Center" />
                                <EditRowStyle BackColor="LightGoldenrodYellow" ForeColor="Black" BorderColor="Blue"
                    ...
                    <tr>
                        <td width="50%" height="50%" valign="top">
                            <asp:DetailsView ID="dvOrderMaster" runat="server" AutoGenerateRows="False" DataKeyNames="OrderID"
                                DataSourceID="sdOrderMaster" Width="100%" Height="50px" BackColor="white" BorderColor="Tan"
                        ...
                        <td width="50%" height="50%" valign="top">
                            <asp:GridView ID="gvOrderDetail" runat="server" BackColor="White" BorderColor="#CC9966"

<%@ Page Title="Change - Order Status" Language="C#" MasterPageFile="Designer.master" AutoEventWireup="true" CodeFile="dsp_ChangeOrderStatus.aspx.cs" Inherits="dsp_AuditNotes" %>
...
<table width="100%" align="center" >
    ...
    <tr>
        ...
        <td align="left" valign="top" style="text-align: left; vertical-align: top">
            <asp:DropDownList ID="ddlAuditNoteType" runat="server"
             CssClass="select"></asp:DropDownList>
        </td>
    </tr>
